-- Expose ONLY sanitized gateway checkout settings to public checkout (no secrets)
...
BEGIN
  SELECT jsonb_build_object(
      ...
      'pix_discount', COALESCE((g.credentials->>'pix_discount')::numeric, 0.05),
      'boleto_discount', COALESCE((g.credentials->>'boleto_discount')::numeric, 0.03),
...
GRANT EXECUTE ON FUNCTION public.get_gateway_checkout_config(uuid) TO public;
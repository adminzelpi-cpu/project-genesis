-- Update RPC to include accepted payment methods
...
BEGIN
  SELECT jsonb_build_object(
      ...
      'pix_expiration_minutes', COALESCE((g.credentials->>'pix_expiration_minutes')::integer, 0),
      'accept_credit_card', g.accept_credit_card,
      'accept_pix', g.accept_pix,
      'accept_boleto', g.accept_boleto,
